    ...
    const actions = [
        {
            ...
            className: 'from-game-purple to-game-sky shadow-game-purple/30',
            emoji: '🧪',
        },
        {
            href: '/battle',
        ...
        },
        {
            ...
            className: 'from-game-sky to-game-purple shadow-game-sky/40',
            emoji: '🏆',
        },
        {
    ...
    return (
        <>
            ...
            <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 p-4 sm:p-6">
                {/* Greeting */}
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-game-purple via-game-sky to-game-lime p-6 text-game-navy shadow-xl sm:p-8">
                    <div
                        aria-hidden
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    {actions.map((action) => (
                        <Link
                            key={action.title}
                            href={action.href}
                            className={`group relative overflow-hidden rounded-3xl bg-gradient-to-br p-6 text-game-navy shadow-lg transition-transform hover:-translate-y-1 hover:scale-[1.02] ${action.className}`}
                        >
                            <span
                                aria-hidden
