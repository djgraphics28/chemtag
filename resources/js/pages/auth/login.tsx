...
const FEATURES = [
    { Icon: Zap, title: '3 Game Modes', desc: 'Name it, match it, decode it' },
    {
        ...
        desc: 'Race the clock, earn big points',
    },
    { Icon: Trophy, title: 'Leaderboards', desc: 'Compete with classmates' },
    {
        Icon: Star,
        title: 'XP & Achievements',
        desc: 'Track your chemistry mastery',
    },
];
...
const STYLES = `
    ...
    @keyframes ct-glow {
        0%,100% { box-shadow: 0 0 20px 5px oklch(0.78 0.10 292 / 0.38); }
        50%     { box-shadow: 0 0 36px 10px oklch(0.78 0.10 292 / 0.62); }
    }
    @keyframes ct-in {
        ...
        >
            <defs>
                <radialGradient id="ct-nuc" cx="35%" cy="30%" r="65%">
                    <stop offset="0%" stopColor="oklch(0.80 0.10 292)" />
                    <stop offset="100%" stopColor="oklch(0.45 0.08 292)" />
                </radialGradient>
                <filter id="ct-gf">
            ...
            <ellipse
                ...
                ry="22"
                fill="none"
                stroke="oklch(0.86 0.10 140 / 0.38)"
                strokeWidth="1.5"
            />
            <ellipse
                rx="68"
                ry="22"
                fill="none"
                stroke="oklch(0.86 0.06 220 / 0.32)"
                strokeWidth="1.5"
                transform="rotate(60)"
            />
            <ellipse
                ...
                ry="22"
                fill="none"
                stroke="oklch(0.78 0.10 292 / 0.32)"
                strokeWidth="1.5"
                transform="rotate(-60)"
            />
            ...
            <circle r="5.5" fill="oklch(0.86 0.10 140)" filter="url(#ct-gf)">
                <animateMotion
                    dur="2.9s"
            ...
            <g transform="rotate(60)">
                <circle r="5" fill="oklch(0.86 0.06 220)" filter="url(#ct-gf)">
                    <animateMotion
                        dur="2.1s"
                        repeatCount="indefinite"
                        begin="-0.8s"
...
export default function Login({ status }: Props) {
    const { name, branding } = usePage<{ name: string; branding?: Branding }>()
        .props;
    ...
    const brandBadge = (size: number, radius: string, fontSize: string) =>
        branding?.app_logo_path ? (
            ...
            <div
                style={{
                    background:
                        'linear-gradient(135deg, oklch(0.78 0.10 292), oklch(0.55 0.08 292))',
                    borderRadius: radius,
                    width: `${size}px`,
                    height: `${size}px`,
                    display: 'flex',
    ...
    return (
        <div
            ...
            style={{ background: 'oklch(0.20 0.03 290)' }}
        >
            <Head title="Log in" />
            ...
            >
                <div
                    style={{
                        ...
                        background: 'oklch(0.78 0.10 292 / 0.16)',
                        width: '520px',
                        height: '520px',
                        borderRadius: '50%',
                        position: 'absolute',
                ...
                <div
                    style={{
                        ...
                        background: 'oklch(0.86 0.06 220 / 0.1)',
                        width: '440px',
                        height: '440px',
                        borderRadius: '50%',
                        position: 'absolute',
                ...
                <div
                    style={{
                        ...
                        background: 'oklch(0.86 0.10 140 / 0.07)',
                        width: '360px',
                        height: '360px',
                        borderRadius: '50%',
                        position: 'absolute',
            ...
            ════════════════════════════════════════════════════ */}
            <div className="relative hidden flex-col justify-between p-14 lg:flex lg:w-[52%] xl:p-20">
                {/* Brand mark */}
                <div className="flex items-center gap-3">
                    <div
                        style={{
                            animation: 'ct-glow 3s ease-in-out infinite',
                            borderRadius: '14px',
                        }}
                    >
                    ...
                    <div>
                        ...
                        <div
                            style={{
                                ...
                                color: 'oklch(0.65 0.05 280 / 0.55)',
                            }}
                        >
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span
                                style={{
                                    background:
                                        'linear-gradient(105deg, oklch(0.86 0.10 140), oklch(0.78 0.10 292) 55%, oklch(0.86 0.06 220))',
                        ...
                        <p
                            style={{
                                color: 'oklch(0.70 0.04 280 / 0.65)',
                                fontSize: '0.88rem',
                                maxWidth: '340px',
                                lineHeight: 1.7,
                            }}
                        >
                            Master IUPAC organic chemistry naming through
                            fast-paced quizzes, real-time scoring, and
            ...
            <div className="relative flex flex-1 items-center justify-center p-6 sm:p-10">
                <div
                    className="ct-in w-full"
                    style={{ maxWidth: '390px', animationDelay: '0.05s' }}
                >
                    {/* Mobile-only brand */}
                    ...
                    <div
                        style={{
                            ...
                            boxShadow:
                                '0 30px 70px oklch(0 0 0 / 0.55), inset 0 1px 0 oklch(1 0 0 / 0.1)',
                        }}
                    >
                        {/* Card header */}
                        <div style={{ marginBottom: '28px' }}>
                            <div
                                style={{
                                    ...
                                    alignItems: 'center',
                                    gap: '6px',
                                    background: 'oklch(0.86 0.10 140 / 0.12)',
                                    border: '1px solid oklch(0.86 0.10 140 / 0.25)',
                                    borderRadius: '100px',
                                    padding: '4px 12px',
                                    fontSize: '0.68rem',
                                    fontWeight: 600,
                            ...
                            >
                                <span
                                    style={{
                                        ...
                                        height: '6px',
                                        borderRadius: '50%',
                                        background: 'oklch(0.86 0.10 140)',
                                        display: 'inline-block',
                                        animation:
                                            'ct-glow 2s ease-in-out infinite',
                                    }}
                                />
                                Player Login
                            </div>
                        ...
                        {status && (
                            <div
                                style={{
                                    background: 'oklch(0.86 0.10 140 / 0.12)',
                                    border: '1px solid oklch(0.86 0.10 140 / 0.28)',
                                    borderRadius: '12px',
                                    padding: '10px 14px',
                                    color: 'oklch(0.86 0.10 140)',
                                    fontSize: '0.82rem',
                                ...
                                <>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <Input
                                            ...
                                            className="border-white/10 bg-white/8 text-white placeholder:text-white/25 focus-visible:border-[oklch(0.78_0.10_292/0.8)] focus-visible:ring-[oklch(0.78_0.10_292/0.2)]"
                                        />
                                    ...
                                    <Button
                                        ...
                                        className="mt-1 h-11 w-full border-0 text-[0.88rem] font-semibold tracking-wide text-[oklch(0.25_0.05_290)]"
                                        style={
                                            {
                                                background: processing
                                                    ? 'oklch(0.55 0.08 292)'
                                                    : 'linear-gradient(135deg, oklch(0.84 0.08 292) 0%, oklch(0.72 0.10 292) 100%)',
                                                boxShadow: processing
                                                    ? 'none'
                                                    : '0 4px 24px oklch(0.78 0.10 292 / 0.4)',
                                                borderRadius: '14px',
                                                transition:
                    ...
                    {/* Mobile tagline */}
                    <p
                        className="mt-5 text-center text-xs lg:hidden"
